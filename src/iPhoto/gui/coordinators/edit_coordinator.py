...
class EditCoordinator(QObject):
    ...
    def _restore_detail_video_preview(self, source: Path) -> None:
        ...
        print(f"DEBUG_VIDEO_BUG: EditCoordinator._restore_detail_video_preview | has_trim={has_trim} | needs_adjusted_preview={needs_adjusted_preview} | raw_adjustments={raw_adjustments}")

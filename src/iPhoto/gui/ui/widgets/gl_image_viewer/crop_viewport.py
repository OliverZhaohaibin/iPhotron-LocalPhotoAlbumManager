...
def update_cover_scale(
    ...
    # Pending CPU images and resident GPU surfaces obey the same geometry.
    # In particular, the first upload must not introduce a different cover.
    display_size = display_texture_dimensions(viewer)
    rotation_cover_scale = compute_rotation_cover_scale(display_size, straighten_deg)

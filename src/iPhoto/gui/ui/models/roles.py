...
class Roles(IntEnum):
    ...
    IS_HEADER = Qt.UserRole + 20
    HEADER_TITLE = Qt.UserRole + 21
    ASPECT_RATIO = Qt.UserRole + 22
    ...
    mapping.update(
        {
            ...
            Roles.IS_HEADER: b"isHeader",
            Roles.HEADER_TITLE: b"headerTitle",
            Roles.ASPECT_RATIO: b"aspectRatio",
        }
    )
    return mapping

# People Dashboard Popup and Visibility Regression Guardrails

This note captures the People dashboard behavior that was lost during the
regression window between commits
...
- Do not use raw `QMessageBox` for People dashboard information or warning
  popups.

...
sys.modules["iPhotos.src.iPhoto.gui.ui.icons"] = MagicMock()
sys.modules["iPhotos.src.iPhoto.gui.ui.icons"].load_icon = MagicMock()
# Also mock the relative import inside window_theme_controller
from iPhotos.src.iPhoto.gui.ui.controllers import window_theme_controller as wtc_module
...
def test_sidebar_palette_application(window_theme_controller, mock_theme_manager):
    ...
    from iPhotos.src.iPhoto.gui.ui.palette import SIDEBAR_SELECTED_BACKGROUND, SIDEBAR_ICON_COLOR

...
class FramelessWindowManager(QObject):
    ...
    def _build_menu_styles(self) -> tuple[str, str]:
        ...
        scrollbar_style = (
            f"QScrollBar:vertical, QAbstractScrollArea QScrollBar:vertical, QListView QScrollBar:vertical, QTreeView QScrollBar:vertical, QTableView QScrollBar:vertical, QScrollArea QScrollBar:vertical {{\n"
            ...
            "    border: none;\n"
            "}\n"
            f"QScrollBar:horizontal, QAbstractScrollArea QScrollBar:horizontal, QListView QScrollBar:horizontal, QTreeView QScrollBar:horizontal, QTableView QScrollBar:horizontal, QScrollArea QScrollBar:horizontal {{\n"
            f"    background-color: {scrollbar_track_hex};\n"
            "    height: 14px;\n"
            "    margin: 0px;\n"
            "    padding: 0px;\n"

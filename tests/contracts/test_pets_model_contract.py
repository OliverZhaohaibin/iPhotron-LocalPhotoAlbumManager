...
MODEL_RELATIVE_PATH = Path("src/extension/models/pets/detector/yolox_nano_coco.onnx")
DOG_IMAGE_URL = "https://raw.githubusercontent.com/Megvii-BaseDetection/YOLOX/main/assets/dog.jpg"
...
def _contract_cache_root() -> Path:
    return Path(
        os.environ.get("IPHOTO_PETS_CONTRACT_CACHE") or Path.home() / ".cache" / "iphoto-contracts"
    )
